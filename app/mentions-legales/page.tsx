...
export default function MentionsLegalesPage() {
  return (
    <div className="min-h-screen pt-28 pb-16">
      <div
        className="max-w-3xl mx-auto px-4 sm:px-6 prose-custom"
        style={{ color: "#C9B6C5" }}
      >
        <h1
        ...
        <section className="mb-8">
          ...
          <p className="font-body text-sm leading-relaxed">
            L'ensemble du contenu de ce site (textes, images, graphismes, logo, nail art)
            est la propriété exclusive de Nailsesari, sauf mention contraire. Toute
            reproduction, distribution ou modification est interdite sans autorisation préalable.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="font-body text-sm leading-relaxed">
            Nailsesari s'efforce d'assurer l'exactitude des informations publiées sur ce site.
            Toutefois, elle ne saurait être tenue responsable des erreurs, omissions ou
            résultats obtenus suite à une mauvaise utilisation de ces informations.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="font-body text-sm leading-relaxed">
            ...
            Aucun cookie publicitaire ou de tracking tiers n'est utilisé sans votre
